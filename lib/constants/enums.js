...
/**
 * User Invitation Status Enum - Statuts des invitations
 * Basé sur l'enum UserInvitationStatus de l'API OpenAPI
 */
...
// Invitation status definitions - NOUVEAU selon OpenAPI
export const INVITATION_STATUS_DEFINITIONS = {
  [UserInvitationStatus.PENDING]: {
    label: 'En attente',
    description: 'Invitation envoyée, en attente d\'acceptation',
    color: 'bg-yellow-500',
    textColor: 'text-yellow-700',
    bgColor: 'bg-yellow-50',
    borderColor: 'border-yellow-300',
  ...
  [UserInvitationStatus.ACCEPTED]: {
    label: 'Acceptée',
    description: 'Invitation acceptée par l\'utilisateur',
    color: 'bg-green-500',
    textColor: 'text-green-700',
    bgColor: 'bg-green-50',
    borderColor: 'border-green-300',
  ...
  [UserInvitationStatus.EXPIRED]: {
    label: 'Expirée',
    description: 'Invitation expirée automatiquement',
    color: 'bg-red-500',
    textColor: 'text-red-700',
    bgColor: 'bg-red-50',
    borderColor: 'border-red-300',
  ...
  [UserInvitationStatus.DELETED]: {
    label: 'Annulée',
    description: 'Invitation annulée manuellement',
    color: 'bg-gray-500',
    textColor: 'text-gray-700',
    bgColor: 'bg-gray-50',
    borderColor: 'border-gray-300',
...
export const getInvitationStatusDefinition = (status) => INVITATION_STATUS_DEFINITIONS[status] || null
...
export const isDeletedStatus = (status) => status === UserStatus.DELETED

// Status helpers - Invitation Status (NOUVEAU)
export const isPendingInvitation = (status) => status === UserInvitationStatus.PENDING
export const isAcceptedInvitation = (status) => status === UserInvitationStatus.ACCEPTED
export const isExpiredInvitation = (status) => status === UserInvitationStatus.EXPIRED
export const isDeletedInvitation = (status) => status === UserInvitationStatus.DELETED
