...
export const ROLE_DASHBOARD_PATHS = {
  [UserRole.SUPER_ADMIN]: '/dashboard/admin', // super_admin - Global Admin Dashboard
  [UserRole.ADMIN]: '/dashboard/company-admin', // admin - Company Management Dashboard  
  [UserRole.DISPATCH]: '/dashboard/dispatcher', // dispatcher - Planning View
  [UserRole.DRIVER]: '/dashboard/driver', // driver - Personal Schedule View
  [UserRole.INTERNAL_SUPPORT]: '/dashboard/support', // internal_support - Support Dashboard
  [UserRole.ACCOUNTANT]: '/dashboard/accountant', // accountant - Financial Dashboard
}
 ...
 * @param {string} role - User role string (OpenAPI values)
...
export function getRoleAllowedPaths(role) {
  ...
  switch(role) {
    case UserRole.SUPER_ADMIN: // super_admin
    ...
    case UserRole.DISPATCH: // dispatcher
      return [
        ...basePaths,
    ...
    case UserRole.INTERNAL_SUPPORT: // internal_support
      return [
        ...basePaths,
        '/dashboard/support',
        '/dashboard/clients',
