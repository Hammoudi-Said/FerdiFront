...
// Enhanced role definitions with 6 roles
const ROLE_DEFINITIONS = {
  '1': {
    id: '1',
    name: 'super_admin',
    label: 'Admin Ferdi',
    description: 'Administrateur éditeur - Accès total',
    color: 'bg-red-500',
  ...
  '2': {
    ...
    permissions: ['users_manage', 'company_manage', 'fleet_manage', 'routes_manage', 'billing_manage', 'support_access'],
  },
  '3': {
    id: '3',
    name: 'dispatch',
